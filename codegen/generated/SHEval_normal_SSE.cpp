...
fTmpC = _mm_set_ps1(-0.48860251190292f);
_mm_store_ps(pSH + 3*4,_mm_mul_ps(fTmpC,fC0));
_mm_store_ps(pSH + 1*4,_mm_mul_ps(fTmpC,fS0));
}
//order 2
...
_mm_store_ps(pSH + 20*4,_mm_add_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(1.984313483298443f),fZ),_mm_load_ps(pSH + 12*4)),_mm_mul_ps(_mm_set_ps1(-1.006230589874905f),_mm_load_ps(pSH + 6*4))));
_mm_store_ps(pSH + 30*4,_mm_add_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(1.98997487421324f),fZ),_mm_load_ps(pSH + 20*4)),_mm_mul_ps(_mm_set_ps1(-1.002853072844814f),_mm_load_ps(pSH + 12*4))));
_mm_store_ps(pSH + 42*4,_mm_add_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(1.993043457183566f),fZ),_mm_load_ps(pSH + 30*4)),_mm_mul_ps(_mm_set_ps1(-1.001542020962219f),_mm_load_ps(pSH + 20*4))));
fC0 = fX;
fS0 = fY;
...
_mm_store_ps(pSH + 45*4,_mm_mul_ps(fTmpA,fC0));
_mm_store_ps(pSH + 39*4,_mm_mul_ps(fTmpA,fS0));
fTmpB = _mm_add_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(2.207940216581961f),fZ),fTmpA),_mm_mul_ps(_mm_set_ps1(-0.959403223600247f),fTmpC));
...
fTmpB = _mm_mul_ps(_mm_set_ps1(2.6459606618019f),fZ);
